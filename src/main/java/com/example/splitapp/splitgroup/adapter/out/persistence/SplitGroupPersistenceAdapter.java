package com.example.splitapp.splitgroup.adapter.out.persistence;

import com.example.splitapp.splitgroup.adapter.out.persistence.entity.SplitGroupEntity;
import com.example.splitapp.splitgroup.adapter.out.persistence.jpa.JpaSplitGroupRepository;
